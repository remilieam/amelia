...
<?php
    ...
    {
        $ReqMdl = "SELECT * FROM MODULE WHERE anneeModule LIKE '%".$_SESSION["_annee"]."%' AND idModule = ".$_GET["module"];
...
<html>
    ...
    <body>
        ...
        <table class="header">
            <tr>
                <td><a href="../accueilEleve.php">Accueil</a> > <?php echo $nomModule; ?></td>
...
<?php
    ...
    if(mysqli_num_rows($TabPrj) != 0)
    {
        ...
        while($LecPrj = mysqli_fetch_array($TabPrj)) // Affichage des projets
        {
            ...
            $ReqNb = "SELECT COUNT(*) AS NbGroupe FROM GROUPE WHERE idProjetGr = '".$LecPrj["idProjet"]."'";
...
?>
            ...
            <h2><a href="module/projet.php?projet=<?php echo $LecPrj["idProjet"]; ?>"><?php echo $LecPrj["nomProjet"]; ?></a></h2>
            ...
            <article>
                <table class="large">
                    ...
                    <tr>
                        ...
                        <td>Nombre de groupe(s) : <?php echo $nb; ?></td>
                    </tr>
                    <tr>
