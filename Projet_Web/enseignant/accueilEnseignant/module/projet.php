...
<html>
    ...
    <body>
        ...
        <table class="header">
            <tr>
                <td><a href="../../accueilEnseignant.php">Accueil</a> > <a href='../module.php?module=<?php echo $idModule; ?>'><?php echo $nomModule; ?></a> > <?php echo $nomProjet ?></td>
        ...
        if(mysqli_num_rows($TabGr) != 0)
        {
            ...
            while($LecGr = mysqli_fetch_array($TabGr))
            {
                ...
                // Affichage de la description du groupe s'il y en a une       
        ...
        else 
        {
            ...
            echo "<article><p>Vous n’avez pas encore validé de groupes dans ce projet !</p></article>";
        }
