...
<?php
    ...
    {
        $ReqGrp = "SELECT * FROM GROUPE, PROJET, MODULE WHERE idModule = idModulePere AND idProjet = idProjetGr AND loginEnseiResp = '".$_COOKIE["_idf"]."' AND idGroupe = ".$_GET["groupe"];
...
<html>
    ...
    <body>
        ...
        <table class="header">
            <tr>
                <td><a href="../../../accueilEnseignant.php">Accueil</a> > <a href='../../module.php?module=<?php echo $idModule; ?>'><?php echo $nomModule; ?></a> > <a href='../projet.php?projet=<?php echo $idProjet; ?>'><?php echo $nomProjet; ?></a> > <?php echo $nomGroupe; ?></td>
        ...
        <section>
            ...
            $ReqEle = "SELECT nom, prenom FROM CONNEXION, GROUPE, appartient WHERE loginEleveAp=login AND idGroupe=idGroupeAp AND idGroupe=".$_GET["groupe"]." AND validation=2";
            ...
            {
                echo $LecEle['prenom']." ".$LecEle['nom']."<br/>";
            }
